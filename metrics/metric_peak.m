% METRIC_PEAK computes the peak value results
%
% Copyright (c) 2026 Robert Bosch GmbH
% SPDX-License-Identifier: AGPL-3.0

function result = metric_peak(x,u,qoi_name,plant_name,quantile_val)
% returns mean, variance and quantiles of the peak values of x or u
...
%   quantile_val    : lower quantile to be computed
    ...
    for i=1:size(qoi,3)
        ...
        result_vec(i,:) = max(abs(qoi(init_complete_idx:end,:,i)),[],1);
    end
    for i=1:size(qoi,2)
